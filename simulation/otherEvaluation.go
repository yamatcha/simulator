...
func PreEval(csvReader *csv.Reader, buf buffer.Buffers, result buffer.ResultData, params buffer.Params) (buffer.Buffers, buffer.ResultData) {
...
func Protocol(csvReader *csv.Reader, buf buffer.Buffers, result buffer.ResultData, params buffer.Params) (buffer.Buffers, buffer.ResultData) {
